...
* * 스토리지 백엔드 *: Astra Control Service가 사용합니다 https://www.netapp.com/cloud-services/cloud-volumes-service-for-google-cloud/["Google Cloud용 NetApp Cloud Volumes Service"^] GKE 클러스터 및 용 백엔드 저장소입니다 AKS 클러스터를 위한 백엔드 스토리지입니다.
+

...
Astra Control Center를 설치하는 동안 Astra Control Center 사용자 정의 리소스 정의(CRD) 파일('Astra_control_center_min YAML')에 'AutoSupport'에 대해 'ACTED:TRUE'를 지정하면 일일 지원 번들이 NetApp 지원 사이트에 자동으로 업로드됩니다.
